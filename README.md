...
Files are essentially JavaScript `Map`s. A hub.txt file is a map with keys as
the first word in each line and the value as the rest of the line, like this:
...
values of the first line of each section and the value is a `Map` of the lines
in that whole section, like this:
...
Type:
[Array](https://developer.mozilla.org/docs/Web/JavaScript/Reference/Global_Objects/Array)<[RaStanza](#rastanza)>
